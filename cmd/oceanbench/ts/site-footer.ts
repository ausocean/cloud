...
export class SiteFooter extends TailwindElement() {
  ...
  @property({ type: String }) orgName =
    "Australian Ocean Laboratory Limited (AusOcean)";
  ...
  override render() {
    return html`
      <footer
        class="w-full border-t border-neutral-200 bg-neutral-50/80 backdrop-blur-sm"
      >
        <div
          class="mx-auto max-w-6xl px-4 py-6 text-center text-sm text-neutral-700"
        >
          <p>

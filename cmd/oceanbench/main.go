/*
NAME
  Ocean Bench - a web app for working with ocean data.
...
// Ocean Bench is a a web app for working with ocean data.
//
// Video can be sent to Ocean Bench in one of two ways:
//

    ...
    ***************************************************************************** */
    ...
    ((function (exports) {
        ...
        ***************************************************************************** */
        ...
        exports.NavMenu = class NavMenu extends s {
            selectedPerm;
            initialised;
            static styles = i$2 `
    ...
    `;
        ...
        `;
            ...
            setPerm(p) {
                this.selectedPerm = p;
                const ul = this.shadowRoot?.querySelector('#menu');
        ...
        ], exports.NavMenu.prototype, "selectedPerm", void 0);
        exports.NavMenu = __decorate([
            e$1('nav-menu')
        ], exports.NavMenu);
    ...
    (function () {
        ...
        ***************************************************************************** */
        ...
        let SiteMenu = class SiteMenu extends s {
            selectedData;
    ...
    `;
        ...
        `;
            ...
            async addOptions(e) {
                ...
                const optgroup = select?.querySelector(`[title="${slot.name}"]`);
                // Load site options into their optgroup.
                this.loadSites(options, optgroup);
            }
            async loadSites(options, optgroup) {
            ...
            checkSelected(option, optGroup, data) {
        ...
        __decorate([
            n$1({ type: String, attribute: 'selected-data' })
        ], SiteMenu.prototype, "selectedData", void 0);
        __decorate([
            n$1({ type: String, attribute: 'selected-perm' })
        ], SiteMenu.prototype, "selectedPerm", void 0);
        __decorate([
            n$1({ type: Boolean })
        ], SiteMenu.prototype, "reloadConfirmed", void 0);
        SiteMenu = __decorate([
            e$1('site-menu')
        ], SiteMenu);
        const permNumber = new Map([
            ["Read Only", 1],
            ["Read Write", 3],
            ["Admin", 7],
        ]);
    ...
    `;
        ...
        _onPermissionChange(event) {
            ...
            const nav = elements.find(element => element.id === "nav-menu");

...
type UserAuth struct {
	...
	sessionKey   string         // Session Key to encrypt cookies.
...
//	sessionKey:   the secure key generated by encryptcookie.GenerateKey().
func (ua *UserAuth) Init() {
	...
	// Configure the sessionKey.
	ua.sessionKey = secrets["sessionKey"]
}

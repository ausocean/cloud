...
// OceanMedia is a broadcast host that streams to OceanMedia.
...
func (o *OceanMedia) CreateBroadcast(
	...
	return nil, IDs{BID: bc.ID, SID: "", CID: ""}, authKey, nil
}
...
// This currently mocks the status enough for broadcasts to be reused.

...
type BroadcastCallback func(context.Context, *broadcast.Config, datastore.Store, broadcasthost.BroadcastHost) error

// Broadcast is an interface for managing broadcasts.
type Broadcast interface {
	CreateBroadcast(cfg *broadcast.Config, store datastore.Store, svc broadcasthost.BroadcastHost) error

	StartBroadcast(ctx context.Context, cfg *broadcast.Config, store datastore.Store, svc broadcasthost.BroadcastHost, extStart func() error,
		onSuccess func(),
		onFailure func(error))
	StopBroadcast(ctx context.Context, cfg *broadcast.Config, store datastore.Store, svc broadcasthost.BroadcastHost) error
	...
	HandleStatus(ctx context.Context, cfg *broadcast.Config, store datastore.Store, svc broadcasthost.BroadcastHost, noBroadcastCallBack BroadcastCallback) error

...
func NewOceanBroadcast(
	...
	return &OceanBroadcast{svc: svc, cfg: cfg, store: store, log: log, setVar: setVar, broadcastByName: broadcastByName}
}
...
func (m *OceanBroadcast) CreateBroadcast(ctx context.Context) error {
	...
	resp, ids, rtmpKey, err := m.svc.CreateBroadcast(
		context.Background(),
		m.cfg.Name+" "+dateStr,
		m.cfg.Description,
		m.cfg.StreamName,
...
func (m *OceanBroadcast) StopBroadcast(ctx context.Context) error {
	...
	err = m.svc.SetBroadcastPrivacy(ctx, m.cfg.BID, m.cfg.PostLivePrivacy)
	if err != nil {
...
func (m *OceanBroadcast) HandleStatus(ctx context.Context, noBroadcastCallBack BroadcastCallback) error {
	...
	if err != nil {
		...
		err := noBroadcastCallBack(ctx, m.cfg, m.store, m.svc)
		if err != nil {
...
func (m *OceanBroadcast) HandleChatMessage(ctx context.Context) error {
	...
	err := m.svc.PostChatMessage(m.cfg.CID, msg)
	if err != nil {
...
func (m *OceanBroadcast) HandleHealth(ctx context.Context, goodHealthCallback func(), badHealthCallback func(string)) error {
	...
	issue, err := m.svc.BroadcastHealth(ctx, m.cfg.SID)
	if err != nil {

...
type OceanBroadcast struct {
	svc   broadcasthost.BroadcastHost
...
func (m *OceanBroadcast) StopBroadcast(ctx context.Context, cfg *broadcast.Config, store datastore.Store, svc broadcasthost.BroadcastHost) error {
...
func (m *OceanBroadcast) HandleStatus(ctx context.Context, cfg *broadcast.Config, store datastore.Store, svc broadcasthost.BroadcastHost, noBroadcastCallBack BroadcastCallback) error {

...
type Broadcast struct {
	...
	ConfigID           string    // Broadcast Config ID.
	StartTime          time.Time // Broadcast start time.
	ScheduledStartTime time.Time // Scheduled start time.
	EndTime            time.Time // Broadcast end time.
